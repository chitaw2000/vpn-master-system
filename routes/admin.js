    ...
    users.forEach((u, index) => {
        ...
        <tr class="border-b border-slate-50 hover:bg-indigo-50/30">
            ...
            <td class="p-4 text-right flex justify-end gap-2">
                <button id="panelBtn-${u.token}" onclick="copyLink('${webPanelLink}', 'panelBtn-${u.token}', '<i class=\\'fas fa-globe\\'></i>')" class="bg-blue-50 text-blue-600 hover:bg-blue-500 hover:text-white px-3 py-2 rounded-lg text-sm font-bold transition" title="Copy User Panel Link"><i class="fas fa-globe"></i></button>
                ...
                <form action="/admin/delete-user" method="POST" onsubmit="return confirm('Master Panel မှာပါ အပြီးအပိုင် ပျက်သွားပါမည်။ ဖျက်မှာ သေချာပြီလား?');" class="m-0">
